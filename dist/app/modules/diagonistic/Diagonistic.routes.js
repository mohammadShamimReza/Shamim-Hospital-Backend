...
router.post('/create', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(Diagonistic_validation_1.DiagnosticValidation.createDiagnostic), Diagonistic_controller_1.DiagnosticController.createDiagnostic);
