...
router.post('/create', (0, auth_1.default)(user_1.ENUM_USER_ROLE.ADMIN), (0, validateRequest_1.default)(Notice_validation_1.NoticeValidation.createNotice), Notice_controller_1.NoticeController.createNotice);
