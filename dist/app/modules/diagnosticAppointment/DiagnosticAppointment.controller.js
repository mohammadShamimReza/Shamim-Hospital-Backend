...
const createDiagnosticAppointment = catchAsync(async (req, res) => {
    const payload = req.body;
    const result = await DiagnosticAppointmentService.createDiagnosticAppointment(payload);
    sendResponse(res, {
...
const updateDiagnosticAppointment = catchAsync(async (req, res) => {
    const id = req.params.id;
    const payload = req.body;
    const result = await DiagnosticAppointmentService.updateDiagnosticAppointment(Number(id), payload);
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
...
const deleteDiagnosticAppointment = catchAsync(async (req, res) => {
    const id = req.params.id;
    const result = await DiagnosticAppointmentService.deleteDiagnosticAppointment(Number(id));
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
