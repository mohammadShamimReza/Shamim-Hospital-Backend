...
const createLabAppointment = catchAsync(async (req, res) => {
...
const updateLabAppointment = catchAsync(async (req, res) => {
    const id = req.params.id;
    const payload = req.body;
    const result = await LabAppointmentService.updateLabAppointment(Number(id), payload);
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
...
const deleteLabAppointment = catchAsync(async (req, res) => {
    const id = req.params.id;
