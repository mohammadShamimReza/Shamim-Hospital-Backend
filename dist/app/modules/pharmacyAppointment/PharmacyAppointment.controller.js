...
const createPharmacyAppointment = catchAsync(async (req, res) => {
    const payload = req.body;
    const result = await PharmacyAppointmentService.createPharmacyAppointment(payload);
    sendResponse(res, {
...
const updatePharmacyAppointment = catchAsync(async (req, res) => {
    const id = req.params.id;
    const payload = req.body;
    const result = await PharmacyAppointmentService.updatePharmacyAppointment(Number(id), payload);
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
...
const deletePharmacyAppointment = catchAsync(async (req, res) => {
    const id = req.params.id;
    const result = await PharmacyAppointmentService.deletePharmacyAppointment(Number(id));
    sendResponse(res, {
        statusCode: StatusCodes.OK,
        success: true,
